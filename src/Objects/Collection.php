...
abstract class Collection extends BaseCollection
{
    ...
    protected function getPropertyValue(string $property, mixed $default = null): mixed
    {
        ...
        $class = 'EdenAI\Objects\\'.Str::studly($property);
    ...
    /**
     * @return array|Enumerable|EnumeratesValues|Collection
     */
    protected function getRelationValue(string $relativeName, iterable $relativeData): mixed
    {
        /** @var class-string<Collection>|list<class-string<Collection>> $relative */
        ...
        /** @var class-string<Collection> $relativeClass */
